...
import { FacebookOutlined, InstagramOutlined, TikTokOutlined, XOutlined } from '@ant-design/icons';
  ...
  return (
    <AntFooter style={{ background: '#1a1a1a', color: '#fff'}}>
      <Row gutter={[16, 32]} justify="space-between" align="middle">
        <Col xs={24} md={8} style={{ textAlign: 'center' }}>
          ...
          <h3 style={{ color: '#fff', marginBottom: 16 }}>
            <img src={text} alt='logo' style={{ height: 50, marginBottom: 16 }} />
          </h3>
          <p style={{ color: '#aaa' }}>Địa chỉ: Lô E2a-7, Đường D1, Đ. D1, Long Thạnh Mỹ, Thành Phố Thủ Đức, Hồ Chí Minh 700000</p>
          <p style={{ color: '#aaa' }}>Số điện thoại: 028 7300 5588</p>
        </Col>
        <Col xs={24} md={8} style={{ textAlign: 'center' }}>
      ...
      <Row justify="center" style={{ marginTop: 32 }}>
        <p style={{ color: '#666', textAlign: 'center' }}>© 2024 Meo Camp. All rights reserved.</p>
      </Row>
    </AntFooter>
  );
};
